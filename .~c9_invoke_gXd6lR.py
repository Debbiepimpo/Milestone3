...
def updaterecipe(recipe_id):
    ...
    if request.form.get('submit') == 'submit':
        ...
        if request.form["image"]=="":
            request.form["image"]="http://sozkibris.com/wp-content/uploads/2017/10/3dbf0726e1dc41349d0.jpg"

        # Check allergies, description and title only, to make sure if the key length hs a value equals to 0 :
        ...
        #If diet is not able at the dictionary recipes-dictionary-form
        if 'diet' not in recipes:
            keys.append('diet')
        #If cuisine not in the recipes-dictionary-form    
